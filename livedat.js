let isDOBOpen = false; //initialy close rkhne ke kiye
let dateOfBirth;
const settingCogEl = document.getElementById("settingIcon");
const settingContentEl = document.getElementById("settingContent");
const initialTextEl = document.getElementById("initialText");
const afterDOBBtnEl =document.getElementById("afterDOBButton");
...
const toggleDateofBirthSelector = () => {
    ...
    isDOBOpen = !isDOBOpen;//negate krne ke liye agr open to close, close h to open
};
...
const setDOBHandler = () => {
    ...
    if(dateOfBirth){ //if dob avalable hoga tb 
